 ...
 * - Erkennung komprimierter Daten eingeführt
 * - Anforderung ungültiger Kompressionstyp angepasst
 * - 
 * 
 */
...
/* 
 * Basisklasse für unkomprimiertes ProPra-Bildformat. Die zugehörige Superklasse
...
//	private int dataSegmentSize; 				// bytes 25,24,23,22,21,20,19,18 (evtl. für später)
	...
	public void readProPraInput(String loc) throws IOException {
		try {
			...
			// Funktioniert nicht (mehr), wird evtl. nachgereicht
			// TODO - falsche Dateigröße erkennen
